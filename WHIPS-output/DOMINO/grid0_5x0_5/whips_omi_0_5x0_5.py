...
for day in timesList:
    ...
    outDir = '/Users/Elise/penn_holloway/WHIPS-output/DOMINO/grid0_5x0_5/'
    call.extend(['--outDirectory', outDir])
    call.extend(['--outFileName', 'knmi_omi_minPix250_maxPix2100_0_5x0_5_CONUS_'+day.strftime('%m-%d-%Y')+'tropVCD_only'+'.nc'])
